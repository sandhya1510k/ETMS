...
const AdminDashboard = () => {
  ...
  return (
    <div className="p-3 space-y-8 bg-white min-h-screen">
      {/* Hero Section */}
      <motion.div
        className="bg-gradient-to-r from-blue-400 to-blue-500 font-bold rounded-2xl p-6 flex flex-col justify-center items-start shadow-lg border-blue-700 relative overflow-hidden"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <motion.div
          className="lg:col-span-5 bg-white rounded-2xl shadow-sm p-6 border border-slate-200"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
